...
contract MomentsPrivateSale is Context, ReentrancyGuard, Owned {
    ...
    function initStages () internal {
        ...
        stages[0].tokensUnlockedPercentage = 200; 
        stages[1].tokensUnlockedPercentage = 314;
        stages[2].tokensUnlockedPercentage = 428;
        stages[3].tokensUnlockedPercentage = 542;
        stages[4].tokensUnlockedPercentage = 656;
        stages[5].tokensUnlockedPercentage = 770;
        stages[6].tokensUnlockedPercentage = 884;
        stages[7].tokensUnlockedPercentage = 1000;
