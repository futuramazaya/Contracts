...
contract MomentsPrivateSale is Context, ReentrancyGuard, Owned {
    ...
    function initStages () internal {
        ...
        stages[0].tokensUnlockedPercentage = 250; 
        stages[1].tokensUnlockedPercentage = 375;
        stages[2].tokensUnlockedPercentage = 500;
        stages[3].tokensUnlockedPercentage = 625;
        stages[4].tokensUnlockedPercentage = 750;
        stages[5].tokensUnlockedPercentage = 875;
        stages[6].tokensUnlockedPercentage = 1000;
