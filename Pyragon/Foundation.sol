...
contract FoundationTokensVesting {
    ...
    function initVestingStages () internal {
        ...
        for(uint256 i = 1; i < 19; i++){
            ...
            stages[i].tokensUnlockedPercentage = (i * startPercent) + 100;
        }
        stages[18].tokensUnlockedPercentage = 1000; //For rounding error
    }
