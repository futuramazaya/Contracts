...
// TRIPToken with Governance.
contract TripToken is BEP20('Tripland', 'TRIP') {
    
    constructor() public {
        mint(msg.sender,400000 * 1e18); //400,000 initial supply
    }
    ...
    function changeCap(uint256 amount) public onlyOwner {
        setCap(amount);
    }
