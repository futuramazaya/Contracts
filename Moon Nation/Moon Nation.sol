...
contract MoonNation is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 384400000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Moon Nation";
    string private _symbol = "NATION";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 3; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3; // 3% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 2; // 2% burn fee
    uint256 private _previousBurnFee = _burnFee;
    
    uint256 public marketingAndDevelopment = 2; // 2% Marketing and Development
    ...
    uint256 public _maxWalletToken = 3844000 * 10**9;
    ...
    constructor (address marketingAndDev) public {
        _rOwned[_msgSender()] = _rTotal;
        _marketingAndDev = marketingAndDev;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Change router address accordingly
    ...
    receive() external payable {
        ...
        msg.sender == address(IUniswapV2Router02(uniswapV2Router).WETH()),"No need for bnb here :)");
    }
