...
contract Lottery is VRFConsumerBase{
    ...
    uint public ticketPrice = 1 * 1e6; // 1$ ticket price (6 decimals)
    uint public poolLimit = 10000 * 1e6; // 10000$ pool limit
    ...
    constructor() VRFConsumerBase (
        ...
        owner = msg.sender;
        token = IERC20(0x8F6b0f39457D7638B05879D3bAf0E80A58aBE0A7); // USDC contract address
    }
