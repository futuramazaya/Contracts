...
contract Leash is Context, IBEP20, Ownable {
    ...
    string private _name = "LEASH";
    string private _symbol = "LEASH";
    uint8 private _decimals = 0;
    
    uint256 public _taxFee = 25; // 2.5% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 50; // 5% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _BurnFee = 25; // 2.5% Burn fee
    ...
    uint256 public _maxTxAmount = 10000000000000; // 1% max transfer amount
    uint256 private numTokensSellToAddToLiquidity = 1000000000000;
    ...
    function setBurnFeePBEPent(uint256 burnFee) external onlyOwner() {
        _BurnFee = burnFee;
    }
