...
contract FRS_Staking {
    ...
    function updateTop10(address _add) private returns(bool) {
        uint256 total = players[_add].total_invested + players[_add].firstLevelDeposit;
    ...
    function displayTop10() view external returns(address[10] memory addr, uint256[10] memory amount){
        for(uint i = 0; i < 10; i++){
